...
{
    /// <inheritdoc />
    public partial class mig_add_02_first_mig : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FailedLoginCount = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TicketRoutes_Tickets_TicketId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketDocuments_TicketId",
                table: "TicketDocuments",
                column: "TicketId");

            migrationBuilder.CreateIndex(
                name: "IX_TicketRoutes_TicketId1",
                table: "TicketRoutes",
                column: "TicketId1");
        }
