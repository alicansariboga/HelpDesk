...
namespace HelpDesk.Persistence.Migrations
{
    ...
    [Migration("20240811121328_mig_add_10_ticketDocument_fileUpload")]
    partial class mig_add_10_ticketDocument_fileUpload
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HelpDesk.Domain.Entities.Mail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HelpDesk.Domain.Entities.TicketDocument", b =>
                {
                    b.HasOne("HelpDesk.Domain.Entities.Mail", "Mail")
                        .WithMany()
